...
params parameters; /* main parameters */
...
int main(int argc, char** argv) {
    ...
    if (parameters.file_type) {
        ...
        parameters.file_type_id = file_packer_get_id(parameters.file_type,
                                                     FALSE);
    } else
        parameters.file_type_id = file_identify(parameters.file_ext, FALSE); 
    switch (parameters.file_type_id) {
        case FILE_ERROR:
            g_printf("Error: I can't open archive file\n"
        ...
        case FILE_NOTYPE:
            if (parameters.file_type)
                ...
                g_printf("Error: RarCrack! can't detect the archive type!\n"
